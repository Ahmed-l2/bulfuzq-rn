  ...
  return (
    <View style={themed($card)}>
      ...
      <View style={themed($bottomRow)}>
        ...
        <View style={themed($detailGroupRight)}>
          <Text size="xs" text="Membership Number" style={themed($muted)} />
          <Text
            size="sm"
            weight="bold"
            text={membershipNumber ?? "Unavailable"}
            style={themed($accentValue)}
          />
        </View>
      </View>
    </View>
...
const $detailGroupRight: ThemedStyle<ViewStyle> = () => ({
  alignItems: "flex-end",
  gap: 4,
})
...
const $accentValue: ThemedStyle<TextStyle> = () => ({ color: "#dc2626" })
